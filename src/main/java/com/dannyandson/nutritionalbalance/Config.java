...
public class Config {
    ...
    static {
        ...
        NUTRIENT_MAX_FOOD_VALUE = SERVER_BUILDER.comment("Max NUs of each nutrient a food can contain. Helps prevent OP food mods from making it impossible to keep nutrients balanced. (default:20.0)")
        ...
        GOOD_NUTRIENTS = SERVER_BUILDER.comment("List of nutrients which only give good effects and do not cause engorgement. You can eat as much as you want (default:vegetables).")
