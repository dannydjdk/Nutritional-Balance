...
public class NutrientGUIHelper {
    ...
    public static void init(INutrientGUIScreen screen, int guiWidth, int guiHeight, int yOffset) {
        ...
        screen.addModWidget(new ModWidget(relX, relY + 5, guiWidth, 10, new TranslatableComponent("nutritionalbalance.nutrients"), 0xFF000000).setTextHAlignment(ModWidget.HAlignment.CENTER).setTextVAlignment(ModWidget.VAlignment.TOP));
        ...
        if (nutrientcount > 0) {
            ...
            for (IPlayerNutrient playerNutrient : iNutritionalBalancePlayer.getPlayerNutrients()) {
                ...
                //draw nutrient label
                screen.addModWidget(new ModWidget(columnBlockRelX, columnDrawY, labelWidth, 10, new TranslatableComponent("nutritionalbalance.nutrient." + playerNutrient.getNutrientName()), 0xFF000000));
