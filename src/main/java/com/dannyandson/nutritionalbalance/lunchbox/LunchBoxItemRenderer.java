...
public class LunchBoxItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    private ResourceLocation LUNCHBOX = ResourceLocation.fromNamespaceAndPath(NutritionalBalance.MODID, "item/lunchbox");
    ...
    public void renderByItem(ItemStack stack, @NotNull ItemDisplayContext context, PoseStack poseStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay) {
        ...
        buffer.addVertex(matrix4f, 0,0,0).setColor(0xFFFFFFFF).setUv(sprite.getU0(), sprite.getV0()).setUv2(lightU, lightV).setNormal(1,0,0);
        buffer.addVertex(matrix4f, 0,1,0).setColor(0xFFFFFFFF).setUv(sprite.getU0(), sprite.getV1()).setUv2(lightU, lightV).setNormal(1,0,0);
        buffer.addVertex(matrix4f, 1,1,0).setColor(0xFFFFFFFF).setUv(sprite.getU1(), sprite.getV1()).setUv2(lightU, lightV).setNormal(1,0,0);
        buffer.addVertex(matrix4f, 1,0,0).setColor(0xFFFFFFFF).setUv(sprite.getU1(), sprite.getV0()).setUv2(lightU, lightV).setNormal(1,0,0);
